using System;
namespace Interface_Segregation.After
{
    class Staff : Employee, IBonusesEntitlement, IHealthInsuranceEntitlement, IPensionEntitlment, IRentalSubsidyEntitlement
    {
